...
const Product = ({post}) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between hover:scale-110 transition duration:300 ease-in shadow-[0_20px_50px_rgba(8,_112,_184,_0.7)] gap-3 p-4 mt-10 ml-5 gap-3 p-4 mt-10 ml-5 rounded-xl ">
